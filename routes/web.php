...
Route::get('/moon-admin/main', [AdminMain::class, 'show']);
Route::get('/{path}/moon-admin/main', [AdminMain::class, 'show'])->where('path', '.*');

Route::get('/moon-admin/settings', [AdminSettings::class, 'show']);
Route::get('/{path}/moon-admin/settings', [AdminSettings::class, 'show'])->where('path', '.*');

Route::get('/moon-admin/content', [AdminContent::class, 'show']);
Route::get('/{path}/moon-admin/content', [AdminContent::class, 'show'])->where('path', '.*');

Route::get('/moon-admin/media', [AdminMedia::class, 'show']);
Route::get('/{path}/moon-admin/media', [AdminMedia::class, 'show'])->where('path', '.*');

Route::get('/moon-admin/pages', [AdminPage::class, 'show']);
Route::get('/{path}/moon-admin/pages', [AdminPage::class, 'show'])->where('path', '.*');

Route::get('/moon-admin/comments', [AdminComment::class, 'show']);
Route::get('/{path}/moon-admin/comments', [AdminComment::class, 'show'])->where('path', '.*');

Route::get('/moon-admin/users', [AdminUser::class, 'show']);
